...
def landing_record_from_download_row(row: Dict[str, Any]) -> Dict[str, Any]:
    ...
    record = {
        ...
        "download_candidate_source": str(row.get("download_candidate_source") or ""),
        "download_candidate_url": str(row.get("download_candidate_url") or ""),
        "download_candidate_kind": str(row.get("download_candidate_kind") or ""),
        "primary_pdf_ready": parse_bool(row.get("primary_pdf_ready")),
        "target_match_signals": parse_json_list(row.get("target_match_signals")),
        "final_pdf_confidence": str(row.get("final_pdf_confidence") or ""),
        "final_pdf_believed_primary": parse_bool(row.get("final_pdf_believed_primary")),
        ...
        merged_rows.append(
            {
                ...
                "download_candidate_source": download.get("download_candidate_source", ""),
                "download_candidate_url": download.get("download_candidate_url", ""),
                "download_candidate_kind": download.get("download_candidate_kind", ""),
                "primary_pdf_ready": download.get("primary_pdf_ready", ""),
                "target_match_signals": json.dumps(list(download.get("target_match_signals") or []), ensure_ascii=False),
                "final_pdf_confidence": download.get("final_pdf_confidence", ""),
                "final_pdf_believed_primary": download.get("final_pdf_believed_primary", ""),
